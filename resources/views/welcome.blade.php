                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        ...
                        <a href="{{ route('guest.index') }}"
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Đăng nhập với tư cách khách
                                </h2>
                        ...
                        <a href="{{ route('login') }}"
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">User</h2>
                        ...
                        <a href="{{ route('admin.dashboard') }}"
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Lecturer</h2>
