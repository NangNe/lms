            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('majors.store') }}" method="POST">
                        @csrf
                        <div class="mb-6">
                            <label for="code" class="block text-gray-700 font-medium mb-2">Mã Chuyên Ngành</label>
                            <input type="text" class="w-full border-gray-300 rounded-lg focus:border-indigo-500 focus:ring-indigo-500" id="code" name="code"
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" class="w-full border-gray-300 rounded-lg focus:border-indigo-500 focus:ring-indigo-500" id="name" name="name"
                        ...
                        <div class="mb-6">
                            ...
                            <textarea class="w-full border-gray-300 rounded-lg focus:border-indigo-500 focus:ring-indigo-500" id="description" name="description" rows="4">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="text-red-600 text-sm mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            <label for="decision_number" class="block text-gray-700 font-medium mb-2">Số Quyết Định</label>
                            <input type="text" class="w-full border-gray-300 rounded-lg focus:border-indigo-500 focus:ring-indigo-500" id="decision_number" name="decision_number"
                        ...
                        <button type="submit" class="bg-blue-600 text-white py-3 px-6 rounded-lg shadow-md hover:bg-blue-700 transition duration-300">Lưu</button>
                    </div>
                    <style>
    body {
