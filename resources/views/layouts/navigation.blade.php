        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:justify-between sm:ms-10 space-x-8" style="margin-left: 100px;">
                    ...
                    <x-nav-link :href="url('/admin/manage')" :active="request()->routeIs('manage')">
                        {{ __('Lecturer') }}
                    </x-nav-link>
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('courses_lo')">
                                {{ __('Course Learning Outcomes') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('material')">
                                {{ __('Materials') }}
                            </x-dropdown-link>
